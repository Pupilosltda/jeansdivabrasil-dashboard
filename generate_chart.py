...
df = pd.read_excel("/home/ubuntu/upload/Relatório-sem-título-jul-1-2025-a-jul-31-2025.xlsx", header=2)
...
ax.set_title("Comparativo de Performance por Plataforma (Julho)")
ax.set_xticks([p + width/2 for p in x])
ax.set_xticklabels(platforms)
ax.legend()

plt.tight_layout()
plt.savefig("/home/ubuntu/performance_chart_julho.png")
